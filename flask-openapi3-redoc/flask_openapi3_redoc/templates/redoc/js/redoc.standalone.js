...
`,Es=ee(Hi)`
  ...
  ${te("Markdown")};
`;var js=Object.defineProperty,$s=Object.defineProperties,Ss=Object.getOwnPropertyDescriptors,Cs=Object.getOwnPropertySymbols,Ps=Object.prototype.hasOwnProperty,As=Object.prototype.propertyIsEnumerable,Is=(e,t,r)=>t in e?js(e,t,{enumerable:!0,configurable:!0,writable:!0,value:r}):e[t]=r;const Ts=H()(Es)`
  display: inline;
`;function _s(t){var r=t,{inline:n,compact:o}=r,i=((e,t)=>{var r={};for(var n in e)Ps.call(e,n)&&t.indexOf(n)<0&&(r[n]=e[n]);if(null!=e&&Cs)for(var n of Cs(e))t.indexOf(n)<0&&As.call(e,n)&&(r[n]=e[n]);return r})(r,["inline","compact"]);const s=n?Ts:Es;return e.createElement(ue,null,(t=>{return e.createElement(s,(r=((e,t)=>{for(var r in t||(t={}))Ps.call(t,r)&&Is(e,r,t[r]);if(Cs)for(var r of Cs(t))As.call(t,r)&&Is(e,r,t[r]);return e})({className:"redoc-markdown "+(i.className||""),dangerouslySetInnerHTML:{__html:(a=t.sanitize,l=i.html,a?ks.sanitize(l):l)},"data-role":i["data-role"]},i),$s(r,Ss({$inline:n,$compact:o}))));var r,a,l}))}class Rs extends e.Component{render(){const{source:t,inline:r,compact:n,className:o,"data-role":i}=this.props,s=new Ur;return e.createElement(_s,{html:s.renderMd(t),inline:r,compact:n,className:o,"data-role":i})}}const Ds=ee.div`
  position: relative;
`,zs=ee.div`
  position: absolute;
  min-width: 80px;
...
`;let Pa=class extends e.Component{render(){const{externalDocs:t}=this.props;return t&&t.url?e.createElement(Ca,{$compact:this.props.compact},e.createElement("a",{href:t.url},t.description||t.url)):null}};Pa=((e,t)=>{for(var r,n=t,o=e.length-1;o>=0;o--)(r=e[o])&&(n=r(n)||n);return n})([ha.observer],Pa);const Aa=ee(Es)`
  table {
    margin-bottom: 0.2em;
  }
`;class Ia extends e.PureComponent{constructor(e){super(e),this.state={collapsed:!0},this.toggle=this.toggle.bind(this)}toggle(){this.setState({collapsed:!this.state.collapsed})}render(){const{values:t,type:r}=this.props,{collapsed:n}=this.state,o=!Array.isArray(t),i=Array.isArray(t)&&t||Object.entries(t||{}).map((([e,t])=>({value:e,description:t}))),{enumSkipQuotes:s,maxDisplayedEnumValues:a}=this.context;if(!i.length)return null;const l=this.state.collapsed&&a?i.slice(0,a):i,c=!!a&&i.length>a,p=a?n?`… ${i.length-a} more`:"Hide":"";return e.createElement("div",null,o?e.createElement(e.Fragment,null,e.createElement(Aa,null,e.createElement("table",null,e.createElement("thead",null,e.createElement("tr",null,e.createElement("th",null,e.createElement(fa,null,"array"===r?_("enumArray"):""," ",1===i.length?_("enumSingleValue"):_("enum"))," "),e.createElement("th",null,e.createElement("strong",null,"Description")))),e.createElement("tbody",null,l.map((({description:t,value:r})=>e.createElement("tr",{key:r},e.createElement("td",null,r),e.createElement("td",null,e.createElement(Rs,{source:t,compact:!0,inline:!0})))))))),c?e.createElement(Ta,{onClick:this.toggle},p):null):e.createElement(e.Fragment,null,e.createElement(fa,null,"array"===r?_("enumArray"):""," ",1===t.length?_("enumSingleValue"):_("enum"),":")," ",l.map(((t,r)=>{const n=s?String(t):JSON.stringify(t);return e.createElement(e.Fragment,{key:r},e.createElement(Ea,null,n)," ")})),c?e.createElement(Ta,{onClick:this.toggle},p):null))}}Ia.contextType=ce;const Ta=ee.span`
  color: ${e=>e.theme.colors.primary.main};
  vertical-align: middle;
  font-size: 13px;
  line-height: 20px;
...
`,_a=ee(Es)`
  margin: 2px 0;
`;class Ra extends e.PureComponent{render(){const t=this.props.extensions;return e.createElement(ce.Consumer,null,(r=>e.createElement(e.Fragment,null,r.showExtensions&&Object.keys(t).map((r=>e.createElement(_a,{key:r},e.createElement(fa,null," ",r.substring(2),": ")," ",e.createElement(ja,null,"string"==typeof t[r]?t[r]:JSON.stringify(t[r]))))))))}}function Da({field:t}){return t.examples?e.createElement(e.Fragment,null,e.createElement(fa,null," ",_("examples"),": "),A(t.examples)?t.examples.map(((r,n)=>{const o=Xe(t,r),i=t.in?String(o):JSON.stringify(o);return e.createElement(e.Fragment,{key:n},e.createElement(Ea,null,i)," ")})):e.createElement(za,null,Object.values(t.examples).map(((r,n)=>e.createElement("li",{key:n+r.value},e.createElement(Ea,null,Xe(t,r.value))," -"," ",r.summary||r.description))))):null}const za=ee.ul`
  margin-top: 1em;
  list-style-position: outside;
`;class La extends e.PureComponent{render(){return 0===this.props.constraints.length?null:e.createElement("span",null," ",this.props.constraints.map((t=>e.createElement($a,{key:t}," ",t," "))))}}const Na=e.memo((function({value:t,label:r,raw:n}){if(void 0===t)return null;const o=n?String(t):JSON.stringify(t);return e.createElement("div",null,e.createElement(fa,null," ",r," ")," ",e.createElement(Ea,null,o))}));function Ma(t){const r=t.schema.pattern,{hideSchemaPattern:n}=e.useContext(ce),[o,i]=e.useState(!1),s=e.useCallback((()=>i(!o)),[o]);return!r||n?null:e.createElement(e.Fragment,null,e.createElement(Oa,null,o||r.length<45?r:`${r.substr(0,45)}...`),r.length>45&&e.createElement(Sa,{onClick:s},o?"Hide pattern":"Show pattern"))}function qa({schema:t}){var r;const{hideSchemaPattern:n}=e.useContext(ce);return t&&((null==t?void 0:t.pattern)&&!n||t.items||t.displayFormat||(null==(r=t.constraints)?void 0:r.length))?e.createElement(Fa,null,"[ items",t.displayFormat&&e.createElement(xa,null," <",t.displayFormat," >"),e.createElement(La,{constraints:t.constraints}),e.createElement(Ma,{schema:t}),t.items&&e.createElement(qa,{schema:t.items})," ]"):null}const Fa=ee(ga)`
  margin: 0 5px;
  vertical-align: text-top;
`;var Ba=Object.defineProperty,Qa=Object.getOwnPropertySymbols,Ua=Object.prototype.hasOwnProperty,Wa=Object.prototype.propertyIsEnumerable,Va=(e,t,r)=>t in e?Ba(e,t,{enumerable:!0,configurable:!0,writable:!0,value:r}):e[t]=r,Ha=(e,t)=>{for(var r in t||(t={}))Ua.call(t,r)&&Va(e,r,t[r]);if(Qa)for(var r of Qa(t))Wa.call(t,r)&&Va(e,r,t[r]);return e};const Ja=(0,ha.observer)((t=>{const{enumSkipQuotes:r,hideSchemaTitles:n}=e.useContext(ce),{showExamples:o,field:i,renderDiscriminatorSwitch:s}=t,{schema:a,description:l,deprecated:c,extensions:p,in:u,const:d}=i,h="array"===a.type||A(a.type)&&a.type.includes("array"),m=r||"header"===u,f=e.useMemo((()=>!o||void 0===i.example&&void 0===i.examples?null:void 0!==i.examples?e.createElement(Da,{field:i}):e.createElement(Na,{label:_("example")+":",value:Xe(i,i.example),raw:Boolean(i.in)})),[i,o]),g=x(a.default)&&i.in?Xe(i,a.default).replace(`${i.name}=`,""):a.default;return e.createElement("div",null,e.createElement("div",null,e.createElement(ga,null,a.typePrefix),e.createElement(ya,null,a.displayType),a.displayFormat&&e.createElement(xa,null," ","<",a.displayFormat,">"," "),a.contentEncoding&&e.createElement(xa,null," ","<",a.contentEncoding,">"," "),a.contentMediaType&&e.createElement(xa,null," ","<",a.contentMediaType,">"," "),a.title&&!n&&e.createElement(ba,null," (",a.title,") "),e.createElement(La,{constraints:a.constraints}),e.createElement(Ma,{schema:a}),a.isCircular&&e.createElement(ka,null," ",_("recursive")," "),h&&a.items&&e.createElement(qa,{schema:a.items})),c&&e.createElement("div",null,e.createElement(Ai,{type:"warning"}," ",_("deprecated")," ")),e.createElement(Na,{raw:m,label:_("default")+":",value:g}),!s&&e.createElement(Ia,{type:a.type,values:a["x-enumDescriptions"]||a.enum})," ",f,e.createElement(Ra,{extensions:Ha(Ha({},p),a.extensions)}),e.createElement("div",null,e.createElement(Rs,{compact:!0,source:l})),a.externalDocs&&e.createElement(Pa,{externalDocs:a.externalDocs,compact:!0}),s&&s(t)||null,d&&e.createElement(Na,{label:_("const")+":",value:d})||null)})),Ya=e.memo(Ja);var Ga=Object.defineProperty,Za=(Object.getOwnPropertyDescriptor,Object.getOwnPropertySymbols),Xa=Object.prototype.hasOwnProperty,Ka=Object.prototype.propertyIsEnumerable,el=(e,t,r)=>t in e?Ga(e,t,{enumerable:!0,configurable:!0,writable:!0,value:r}):e[t]=r;let tl=class extends e.Component{constructor(){super(...arguments),this.toggle=()=>{void 0===this.props.field.expanded&&this.props.expandByDefault?this.props.field.collapse():this.props.field.toggle()},this.handleKeyPress=e=>{"Enter"===e.key&&(e.preventDefault(),this.toggle())}}render(){const{hidePropertiesPrefix:t}=this.context,{className:r="",field:n,isLast:o,expandByDefault:i,fieldParentsName:s=[]}=this.props,{name:a,deprecated:l,required:c,kind:p}=n,u=!n.schema.isPrimitive&&!n.schema.isCircular,d=void 0===n.expanded?i:n.expanded,h=e.createElement(e.Fragment,null,"additionalProperties"===p&&e.createElement(wa,null,"additional property"),"patternProperties"===p&&e.createElement(wa,null,"pattern property"),c&&e.createElement(va,null,"required")),m=u?e.createElement(ma,{className:l?"deprecated":"",kind:p,title:a},e.createElement(Li,null),e.createElement("button",{onClick:this.toggle,onKeyPress:this.handleKeyPress,"aria-label":`expand ${a}`},!t&&s.map((e=>e+".​")),e.createElement("span",{className:"property-name"},a),e.createElement(Pi,{direction:d?"down":"right"})),h):e.createElement(Di,{className:l?"deprecated":void 0,kind:p,title:a},e.createElement(Li,null),!t&&s.map((e=>e+".​")),e.createElement("span",{className:"property-name"},a),h);return e.createElement(e.Fragment,null,e.createElement("tr",{className:o?"last "+r:r},m,e.createElement(zi,null,e.createElement(Ya,((e,t)=>{for(var r in t||(t={}))Xa.call(t,r)&&el(e,r,t[r]);if(Za)for(var r of Za(t))Ka.call(t,r)&&el(e,r,t[r]);return e})({},this.props)))),d&&u&&e.createElement("tr",{key:n.name+"inner"},e.createElement(Ri,{colSpan:2},e.createElement(Ni,null,e.createElement(zl,{schema:n.schema,fieldParentsName:[...s||[],n.name],skipReadOnly:this.props.skipReadOnly,skipWriteOnly:this.props.skipWriteOnly,showTitle:this.props.showTitle,level:this.props.level})))))}};tl.contextType=ce,tl=((e,t)=>{for(var r,n=t,o=e.length-1;o>=0;o--)(r=e[o])&&(n=r(n)||n);return n})([ha.observer],tl),Object.defineProperty,Object.getOwnPropertyDescriptor;let rl=class extends e.Component{constructor(){super(...arguments),this.changeActiveChild=e=>{void 0!==e.idx&&this.props.parent.activateOneOf(e.idx)}}sortOptions(e,t){if(0===t.length)return;const r={};t.forEach(((e,t)=>{r[e]=t})),e.sort(((e,t)=>r[e.value]>r[t.value]?1:-1))}render(){const{parent:t,enumValues:r}=this.props;if(void 0===t.oneOf)return null;const n=t.oneOf.map(((e,t)=>({value:e.title,idx:t}))),o=n[t.activeOneOf].value;return this.sortOptions(n,r),e.createElement(ds,{value:o,options:n,onChange:this.changeActiveChild,ariaLabel:"Example"})}};rl=((e,t)=>{for(var r,n=t,o=e.length-1;o>=0;o--)(r=e[o])&&(n=r(n)||n);return n})([ha.observer],rl);const nl=(0,ha.observer)((({schema:{fields:t=[],title:r},showTitle:n,discriminator:o,skipReadOnly:i,skipWriteOnly:s,level:a,fieldParentsName:l})=>{const{expandSingleSchemaField:c,showObjectSchemaExamples:p,schemasExpansionLevel:u}=e.useContext(ce),h=e.useMemo((()=>i||s?t.filter((e=>!(i&&e.schema.readOnly||s&&e.schema.writeOnly))):t),[i,s,t]),m=c&&1===h.length||u>=a;return e.createElement(Mi,null,n&&e.createElement(Ti,null,r),e.createElement("tbody",null,d(h,((t,r)=>e.createElement(tl,{key:t.name,isLast:r,field:t,expandByDefault:m,fieldParentsName:Number(a)>1?l:[],renderDiscriminatorSwitch:(null==o?void 0:o.fieldName)===t.name?()=>e.createElement(rl,{parent:o.parentSchema,enumValues:t.schema.enum}):void 0,className:t.expanded?"expanded":void 0,showExamples:p,skipReadOnly:i,skipWriteOnly:s,showTitle:n,level:a})))))}));var ol=Object.defineProperty,il=Object.defineProperties,sl=Object.getOwnPropertyDescriptors,al=Object.getOwnPropertySymbols,ll=Object.prototype.hasOwnProperty,cl=Object.prototype.propertyIsEnumerable,pl=(e,t,r)=>t in e?ol(e,t,{enumerable:!0,configurable:!0,writable:!0,value:r}):e[t]=r,ul=(e,t)=>{for(var r in t||(t={}))ll.call(t,r)&&pl(e,r,t[r]);if(al)for(var r of al(t))cl.call(t,r)&&pl(e,r,t[r]);return e},dl=(e,t)=>il(e,sl(t));const hl=ee.div`
  padding-left: ${({theme:e})=>2*e.spacing.unit}px;
`;class ml extends e.PureComponent{render(){const t=this.props.schema,r=t.items,n=this.props.fieldParentsName,o=void 0===t.minItems&&void 0===t.maxItems?"":`(${it(t)})`,i=n?[...n.slice(0,-1),n[n.length-1]+"[]"]:n;return t.fields?e.createElement(nl,dl(ul({},this.props),{level:this.props.level,fieldParentsName:i})):!t.displayType||r||o.length?e.createElement("div",null,e.createElement(Qi,null," Array ",o),e.createElement(hl,null,e.createElement(zl,dl(ul({},this.props),{schema:r,fieldParentsName:i}))),e.createElement(Ui,null)):e.createElement("div",null,e.createElement(ya,null,t.displayType))}}var fl=Object.defineProperty,gl=Object.defineProperties,yl=Object.getOwnPropertyDescriptor,bl=Object.getOwnPropertyDescriptors,xl=Object.getOwnPropertySymbols,vl=Object.prototype.hasOwnProperty,wl=Object.prototype.propertyIsEnumerable,kl=(e,t,r)=>t in e?fl(e,t,{enumerable:!0,configurable:!0,writable:!0,value:r}):e[t]=r,Ol=(e,t,r,n)=>{for(var o,i=n>1?void 0:n?yl(t,r):t,s=e.length-1;s>=0;s--)(o=e[s])&&(i=(n?o(t,r,i):o(i))||i);return n&&i&&fl(t,r,i),i};let El=class extends e.Component{constructor(){super(...arguments),this.activateOneOf=()=>{this.props.schema.activateOneOf(this.props.idx)}}render(){const{idx:t,schema:r,subSchema:n}=this.props;return e.createElement(Bi,{$deprecated:n.deprecated,$active:t===r.activeOneOf,onClick:this.activateOneOf},n.title||n.typePrefix+n.displayType)}};El=Ol([ha.observer],El);let jl=class extends e.Component{render(){const{schema:{oneOf:t},schema:r}=this.props;if(void 0===t)return null;const n=t[r.activeOneOf];return e.createElement("div",null,e.createElement(Fi,null," ",r.oneOfType," "),e.createElement(qi,null,t.map(((t,n)=>e.createElement(El,{key:t.pointer,schema:r,subSchema:t,idx:n})))),e.createElement("div",null,t[r.activeOneOf].deprecated&&e.createElement(Ai,{type:"warning"},"Deprecated")),e.createElement(La,{constraints:n.constraints}),e.createElement(zl,(o=((e,t)=>{for(var r in t||(t={}))vl.call(t,r)&&kl(e,r,t[r]);if(xl)for(var r of xl(t))wl.call(t,r)&&kl(e,r,t[r]);return e})({},this.props),gl(o,bl({schema:n})))));var o}};jl=Ol([ha.observer],jl);const $l=(0,ha.observer)((({schema:t})=>e.createElement("div",null,e.createElement(ya,null,t.displayType),t.title&&e.createElement(ba,null," ",t.title," "),e.createElement(ka,null," ",_("recursive")," "))));var Sl=Object.defineProperty,Cl=Object.defineProperties,Pl=(Object.getOwnPropertyDescriptor,Object.getOwnPropertyDescriptors),Al=Object.getOwnPropertySymbols,Il=Object.prototype.hasOwnProperty,Tl=Object.prototype.propertyIsEnumerable,_l=(e,t,r)=>t in e?Sl(e,t,{enumerable:!0,configurable:!0,writable:!0,value:r}):e[t]=r,Rl=(e,t)=>{for(var r in t||(t={}))Il.call(t,r)&&_l(e,r,t[r]);if(Al)for(var r of Al(t))Tl.call(t,r)&&_l(e,r,t[r]);return e},Dl=(e,t)=>Cl(e,Pl(t));let zl=class extends e.Component{render(){var t;const r=this.props,{schema:n}=r,o=((e,t)=>{var r={};for(var n in e)Il.call(e,n)&&t.indexOf(n)<0&&(r[n]=e[n]);if(null!=e&&Al)for(var n of Al(e))t.indexOf(n)<0&&Tl.call(e,n)&&(r[n]=e[n]);return r})(r,["schema"]),i=(o.level||0)+1;if(!n)return e.createElement("em",null," Schema not provided ");const{type:s,oneOf:a,discriminatorProp:l,isCircular:c}=n;if(c)return e.createElement($l,{schema:n});if(void 0!==l){if(!a||!a.length)return console.warn(`Looks like you are using discriminator wrong: you don't have any definition inherited from the ${n.title}`),null;const t=a[n.activeOneOf];return t.isCircular?e.createElement($l,{schema:t}):e.createElement(nl,Dl(Rl({},o),{level:i,schema:t,discriminator:{fieldName:l,parentSchema:n}}))}if(void 0!==a)return e.createElement(jl,Rl({schema:n},o));const p=A(s)?s:[s];if(p.includes("object")){if(null==(t=n.fields)?void 0:t.length)return e.createElement(nl,Dl(Rl({},this.props),{level:i}))}else if(p.includes("array"))return e.createElement(ml,Dl(Rl({},this.props),{level:i}));const u={schema:n,name:"",required:!1,description:n.description,externalDocs:n.externalDocs,deprecated:!1,toggle:()=>null,expanded:!1};return e.createElement("div",null,e.createElement(Ya,{field:u}))}};zl=((e,t)=>{for(var r,n=t,o=e.length-1;o>=0;o--)(r=e[o])&&(n=r(n)||n);return n})([ha.observer],zl);var Ll=Object.defineProperty,Nl=Object.defineProperties,Ml=Object.getOwnPropertyDescriptors,ql=Object.getOwnPropertySymbols,Fl=Object.prototype.hasOwnProperty,Bl=Object.prototype.propertyIsEnumerable,Ql=(e,t,r)=>t in e?Ll(e,t,{enumerable:!0,configurable:!0,writable:!0,value:r}):e[t]=r;class Ul extends e.PureComponent{constructor(){super(...arguments),this.renderDropdown=t=>{return e.createElement(ws,(r=((e,t)=>{for(var r in t||(t={}))Fl.call(t,r)&&Ql(e,r,t[r]);if(ql)for(var r of ql(t))Bl.call(t,r)&&Ql(e,r,t[r]);return e})({Label:ms,Dropdown:ca},t),Nl(r,Ml({variant:"dark"}))));var r}}static getMediaType(e,t){if(!e)return{};const r={schema:{$ref:e}};return t&&(r.examples={example:{$ref:t}}),r}get mediaModel(){const{parser:e,schemaRef:t,exampleRef:r,options:n}=this.props;return this._mediaModel||(this._mediaModel=new Yn(e,"json",!1,Ul.getMediaType(t,r),n)),this._mediaModel}render(){const{showReadOnly:t=!0,showWriteOnly:r=!1,showExample:n=!0}=this.props;return e.createElement(li,null,e.createElement(ui,null,e.createElement(ai,null,e.createElement(zl,{skipWriteOnly:!r,skipReadOnly:!t,schema:this.mediaModel.schema})),n&&e.createElement(pi,null,e.createElement(Wl,null,e.createElement(ua,{renderDropdown:this.renderDropdown,mediaType:this.mediaModel})))))}}const Wl=ee.div`
  background: ${({theme:e})=>e.codeBlock.backgroundColor};
  & > div,
  & > pre {
    padding: ${e=>4*e.theme.spacing.unit}px;
...
`;function tc({children:t,height:r}){const n=e.createRef(),[o,i]=e.useState(!1),[s,a]=e.useState(!1);return e.useEffect((()=>{n.current&&n.current.clientHeight+20<n.current.scrollHeight&&a(!0)}),[n]),e.createElement(e.Fragment,null,e.createElement(rc,{ref:n,className:o?"":"container",style:{height:o?"auto":r}},t),e.createElement(nc,{$dimmed:!o},s&&e.createElement(oc,{onClick:()=>{i(!o)}},o?"See less":"See more")))}const rc=H().div`
  overflow-y: hidden;
`,nc=H().div`
  text-align: center;
  line-height: 1.5em;
...
`,oc=H().a`
  cursor: pointer;
`,ic=e.memo((function(t){const{type:r,flow:n,RequiredScopes:o}=t,i=Object.keys((null==n?void 0:n.scopes)||{});return e.createElement(e.Fragment,null,e.createElement(Kl,null,e.createElement("b",null,"Flow type: "),e.createElement("code",null,r," ")),("implicit"===r||"authorizationCode"===r)&&e.createElement(Kl,null,e.createElement("strong",null," Authorization URL: "),e.createElement("code",null,e.createElement("a",{target:"_blank",rel:"noopener noreferrer",href:n.authorizationUrl},n.authorizationUrl))),("password"===r||"clientCredentials"===r||"authorizationCode"===r)&&e.createElement(Kl,null,e.createElement("b",null," Token URL: "),e.createElement("code",null,n.tokenUrl)),n.refreshUrl&&e.createElement(Kl,null,e.createElement("strong",null," Refresh URL: "),e.createElement("code",null,n.refreshUrl)),!!i.length&&e.createElement(e.Fragment,null,o||null,e.createElement(Kl,null,e.createElement("b",null," Scopes: ")),e.createElement(tc,{height:"4em"},e.createElement("ul",null,i.map((t=>e.createElement("li",{key:t},e.createElement("code",null,t)," -"," ",e.createElement(Rs,{className:"redoc-markdown",inline:!0,source:n.scopes[t]||""}))))))))}));function sc(t){const{RequiredScopes:r,scheme:n}=t;return e.createElement(Es,null,n.apiKey?e.createElement(e.Fragment,null,e.createElement(Kl,null,e.createElement("b",null,j(n.apiKey.in||"")," parameter name: "),e.createElement("code",null,n.apiKey.name)),r):n.http?e.createElement(e.Fragment,null,e.createElement(Kl,null,e.createElement("b",null,"HTTP Authorization Scheme: "),e.createElement("code",null,n.http.scheme)),e.createElement(Kl,null,"bearer"===n.http.scheme&&n.http.bearerFormat&&e.createElement(e.Fragment,null,e.createElement("b",null,"Bearer format: "),e.createElement("code",null,n.http.bearerFormat))),r):n.openId?e.createElement(e.Fragment,null,e.createElement(Kl,null,e.createElement("b",null,"Connect URL: "),e.createElement("code",null,e.createElement("a",{target:"_blank",rel:"noopener noreferrer",href:n.openId.connectUrl},n.openId.connectUrl))),r):n.flows?Object.keys(n.flows).map((t=>e.createElement(ic,{key:t,type:t,RequiredScopes:r,flow:n.flows[t]}))):null)}const ac={oauth2:"OAuth2",apiKey:"API Key",http:"HTTP",openIdConnect:"OpenID Connect"};class lc extends e.PureComponent{render(){return this.props.securitySchemes.schemes.map((t=>e.createElement(li,{id:t.sectionId,key:t.id},e.createElement(ui,null,e.createElement(ai,null,e.createElement(fi,null,e.createElement(Si,{to:t.sectionId}),t.displayName),e.createElement(Rs,{source:t.description||""}),e.createElement(ec,null,e.createElement(Kl,null,e.createElement("b",null,"Security Scheme Type: "),e.createElement("span",null,ac[t.type]||t.type)),e.createElement(sc,{scheme:t})))))))}}var cc=(e,t,r)=>new Promise(((n,o)=>{var i=e=>{try{a(r.next(e))}catch(e){o(e)}},s=e=>{try{a(r.throw(e))}catch(e){o(e)}},a=e=>e.done?n(e.value):Promise.resolve(e.value).then(i,s);a((r=r.apply(e,t)).next())}));function pc(e,t){return cc(this,arguments,(function*(e,t,r={}){const n=yield ye(e||t);return new uc(n,t,r)}))}class uc{constructor(e,t,r={},n=!0){this.marker=new Ht,this.disposer=null,this.rawOptions=r,this.options=new W(r,dc),this.scroll=new ii(this.options),ti.updateOnHistory(Wt.currentId,this.scroll),this.spec=new Do(e,t,this.options),this.menu=new ti(this.spec,this.scroll,Wt),this.options.disableSearch||(this.search=new si,n&&this.search.indexItems(this.menu.items),this.disposer=(0,de.observe)(this.menu,"activeItemIdx",(e=>{this.updateMarkOnMenu(e.newValue)})))}static fromJS(e){const t=new uc(e.spec.data,e.spec.url,e.options,!1);return t.menu.activeItemIdx=e.menu.activeItemIdx||0,t.menu.activate(t.menu.flatItems[t.menu.activeItemIdx]),t.options.disableSearch||t.search.load(e.searchIndex),t}onDidMount(){this.menu.updateOnHistory(),this.updateMarkOnMenu(this.menu.activeItemIdx)}dispose(){this.scroll.dispose(),this.menu.dispose(),this.search&&this.search.dispose(),null!=this.disposer&&this.disposer()}toJS(){return cc(this,null,(function*(){return{menu:{activeItemIdx:this.menu.activeItemIdx},spec:{url:this.spec.parser.specUrl,data:this.spec.parser.spec},searchIndex:this.search?yield this.search.toJS():void 0,options:this.rawOptions}}))}updateMarkOnMenu(e){const t=Math.max(0,e),r=Math.min(this.menu.flatItems.length,t+5),n=[];for(let e=t;e<r;e++){const t=this.menu.getElementAt(e);t&&n.push(t)}if(-1===e&&s){const e=document.querySelector('[data-role="redoc-description"]'),t=document.querySelector('[data-role="redoc-summary"]');e&&n.push(e),t&&n.push(t)}this.marker.addOnly(n),this.marker.mark()}}const dc={allowedMdComponents:{[dt]:{component:lc,propsSelector:e=>({securitySchemes:e.spec.securitySchemes})},[ht]:{component:lc,propsSelector:e=>({securitySchemes:e.spec.securitySchemes})},[mt]:{component:Ul,propsSelector:e=>({parser:e.spec.parser,options:e.options})}}},hc=ee(mi)`
  margin-top: 0;
  margin-bottom: 0.5em;
...
`,yc=ee.div`
  ...
  margin-left: -${15}px;
`;Object.defineProperty,Object.getOwnPropertyDescriptor;let bc=class extends e.Component{render(){const{store:t}=this.props,{info:r,externalDocs:n}=t.spec,o=t.options.hideDownloadButtons,i=r.downloadUrls,s=r.downloadFileName,a=r.license&&e.createElement(fc,null,"License:"," ",r.license.identifier?r.license.identifier:e.createElement("a",{href:r.license.url},r.license.name))||null,l=r.contact&&r.contact.url&&e.createElement(fc,null,"URL: ",e.createElement("a",{href:r.contact.url},r.contact.url))||null,c=r.contact&&r.contact.email&&e.createElement(fc,null,r.contact.name||"E-mail",":"," ",e.createElement("a",{href:"mailto:"+r.contact.email},r.contact.email))||null,p=r.termsOfService&&e.createElement(fc,null,e.createElement("a",{href:r.termsOfService},"Terms of Service"))||null,u=r.version&&e.createElement("span",null,"(",r.version,")")||null;return e.createElement(li,null,e.createElement(ui,null,e.createElement(ai,{className:"api-info"},e.createElement(hc,null,r.title," ",u),!o&&e.createElement("p",null,_("downloadSpecification"),":",null==i?void 0:i.map((({title:t,url:r})=>e.createElement(mc,{download:s||!0,target:"_blank",href:r,rel:"noreferrer",key:r},t)))),e.createElement(Es,null,(r.license||r.contact||r.termsOfService)&&e.createElement(gc,null,e.createElement(yc,null,c," ",l," ",a," ",p))||null),e.createElement(Rs,{source:t.spec.info.summary,"data-role":"redoc-summary"}),e.createElement(Rs,{source:t.spec.info.description,"data-role":"redoc-description"}),n&&e.createElement(Pa,{externalDocs:n}))))}};bc=((e,t)=>{for(var r,n=t,o=e.length-1;o>=0;o--)(r=e[o])&&(n=r(n)||n);return n})([ha.observer],bc);const xc=ee.img`
...
`,wc=ee.a`
  display: inline-block;
`;Object.defineProperty,Object.getOwnPropertyDescriptor;let kc=class extends e.Component{render(){const{info:t}=this.props,r=t["x-logo"];if(!r||!r.url)return null;const n=r.href||t.contact&&t.contact.url,o=r.altText?r.altText:"logo",i=e.createElement(xc,{src:r.url,alt:o});return e.createElement(vc,{style:{backgroundColor:r.backgroundColor}},n?(s=n,t=>e.createElement(wc,{href:s},t))(i):i);var s}};kc=((e,t)=>{for(var r,n=t,o=e.length-1;o>=0;o--)(r=e[o])&&(n=r(n)||n);return n})([ha.observer],kc);var Oc=Object.defineProperty,Ec=Object.getOwnPropertySymbols,jc=Object.prototype.hasOwnProperty,$c=Object.prototype.propertyIsEnumerable,Sc=(e,t,r)=>t in e?Oc(e,t,{enumerable:!0,configurable:!0,writable:!0,value:r}):e[t]=r,Cc=(e,t)=>{for(var r in t||(t={}))jc.call(t,r)&&Sc(e,r,t[r]);if(Ec)for(var r of Ec(t))$c.call(t,r)&&Sc(e,r,t[r]);return e};class Pc extends e.Component{render(){return e.createElement(ue,null,(t=>e.createElement(ki,null,(e=>this.renderWithOptionsAndStore(t,e)))))}renderWithOptionsAndStore(t,r){const{source:n,htmlWrap:o=e=>e}=this.props;if(!r)throw new Error("When using components in markdown, store prop must be provided");const i=new Ur(t,this.props.parentId).renderMdWithComponents(n);return i.length?i.map(((t,n)=>{if("string"==typeof t)return e.cloneElement(o(e.createElement(_s,{html:t,inline:!1,compact:!1})),{key:n});const i=t.component;return e.createElement(i,Cc({key:n},Cc(Cc({},t.props),t.propsSelector(r))))})):null}}var Ac=require("classnames");const Ic=ee.span.attrs((e=>({className:`operation-type ${e.type}`})))`
  width: 9ex;
  display: inline-block;
...
`;function Tc(e,{theme:t},r){return e>1?t.sidebar.level1Items[r]:1===e?t.sidebar.groupItems[r]:""}const _c=ee.ul`
  margin: 0;
  padding: 0;
...
`,Dc={0:Y`
  ...
  `},zc=ee.label.attrs((e=>({className:Ac("-depth"+e.$depth,{active:e.$active})})))`
  cursor: pointer;
  color: ${e=>e.$active?Tc(e.$depth,e,"activeTextColor"):e.theme.sidebar.textColor};
  margin: 0;
  ...
  font-family: ${e=>e.theme.typography.headings.fontFamily};
  ${e=>Dc[e.$depth]};
  background-color: ${e=>e.$active?Tc(e.$depth,e,"activeBackgroundColor"):e.theme.sidebar.backgroundColor};

  ${e=>e.$deprecated&&Ii||""};

  &:hover {
    color: ${e=>Tc(e.$depth,e,"activeTextColor")};
    background-color: ${e=>Tc(e.$depth,e,"activeBackgroundColor")};
  }
...
`,Fc=ee(Ic)`
  margin: 0 5px 0 0;
`,Bc=ee((t=>{const{name:r,opened:n,className:o,onClick:i,httpVerb:s,deprecated:a}=t;return e.createElement(Mc,{className:o,onClick:i||void 0},e.createElement(Fc,{type:s},yt(s)),e.createElement(Pi,{size:"1.5em",direction:n?"down":"right",float:"left"}),e.createElement(qc,{$deprecated:a},r),a?e.createElement(Ai,{type:"warning"}," ",_("deprecated")," "):null)}))`
  padding: 10px;
  border-radius: 2px;
  margin-bottom: 4px;
  line-height: 1.5em;
...
`,Qc=ee.div`
  ...
  margin-bottom: 5px;
  margin-top: 5px;
`;class Uc extends e.PureComponent{constructor(){super(...arguments),this.selectElement=()=>{Bs.selectElement(this.child)}}render(){const{children:t}=this.props;return e.createElement("div",{ref:e=>this.child=e,onClick:this.selectElement,onFocus:this.selectElement,tabIndex:0,role:"button"},t)}}const Wc=ee.div`
  cursor: pointer;
  position: relative;
  margin-bottom: 5px;
`,Vc=ee.span`
...
`,Jc=ee.span.attrs((e=>({className:`http-verb ${e.type}`})))`
...
`;class Xc extends e.Component{constructor(e){super(e),this.toggle=()=>{this.setState({expanded:!this.state.expanded})},this.state={expanded:!1}}render(){const{operation:t,inverted:r,hideHostname:n}=this.props,{expanded:o}=this.state;return e.createElement(ce.Consumer,null,(i=>e.createElement(Wc,null,e.createElement(Hc,{onClick:this.toggle,$expanded:o,$inverted:r},e.createElement(Jc,{type:t.httpVerb,$compact:this.props.compact},t.httpVerb),e.createElement(Vc,null,t.path),e.createElement(Pi,{float:"right",color:r?"black":"white",size:"20px",direction:o?"up":"down",style:{marginRight:"-25px"}})),e.createElement(Yc,{$expanded:o,"aria-hidden":!o},t.servers.map((r=>{const o=i.expandDefaultServerVariables?pt(r.url,r.variables):r.url,s=E(o);return e.createElement(Gc,{key:o},e.createElement(Rs,{source:r.description||"",compact:!0}),e.createElement(Uc,null,e.createElement(Zc,null,e.createElement("span",null,n||i.hideHostname?"/"===s?"":s:o),t.path)))}))))))}}class Kc extends e.PureComponent{render(){const{place:t,parameters:r}=this.props;return r&&r.length?e.createElement("div",{key:t},e.createElement(bi,null,t," Parameters"),e.createElement(Mi,null,e.createElement("tbody",null,d(r,((t,r)=>e.createElement(tl,{key:t.name,isLast:r,field:t,showExamples:!0})))))):null}}Object.defineProperty,Object.getOwnPropertyDescriptor;let ep=class extends e.Component{constructor(){super(...arguments),this.switchMedia=({idx:e})=>{this.props.content&&void 0!==e&&this.props.content.activate(e)}}render(){const{content:t}=this.props;if(!t||!t.mediaTypes||!t.mediaTypes.length)return null;const r=t.activeMimeIdx,n=t.mediaTypes.map(((e,t)=>({value:e.name,idx:t})));return e.createElement(e.Fragment,null,e.createElement((({children:t})=>this.props.withLabel?e.createElement(la,null,e.createElement(aa,null,"Content type"),t):t),null,this.props.renderDropdown({value:n[r].value,options:n,onChange:this.switchMedia,ariaLabel:"Content type"})),this.props.children(t.active))}};ep=((e,t)=>{for(var r,n=t,o=e.length-1;o>=0;o--)(r=e[o])&&(n=r(n)||n);return n})([ha.observer],ep);var tp=Object.defineProperty,rp=Object.getOwnPropertySymbols,np=Object.prototype.hasOwnProperty,op=Object.prototype.propertyIsEnumerable,ip=(e,t,r)=>t in e?tp(e,t,{enumerable:!0,configurable:!0,writable:!0,value:r}):e[t]=r,sp=(e,t)=>{for(var r in t||(t={}))np.call(t,r)&&ip(e,r,t[r]);if(rp)for(var r of rp(t))op.call(t,r)&&ip(e,r,t[r]);return e},ap=(e,t)=>{var r={};for(var n in e)np.call(e,n)&&t.indexOf(n)<0&&(r[n]=e[n]);if(null!=e&&rp)for(var n of rp(e))t.indexOf(n)<0&&op.call(e,n)&&(r[n]=e[n]);return r};const lp=["path","query","cookie","header"];class cp extends e.PureComponent{orderParams(e){const t={};return e.forEach((e=>{var r,n,o;o=e,(r=t)[n=e.in]||(r[n]=[]),r[n].push(o)})),t}render(){const{body:t,parameters:r=[]}=this.props;if(void 0===t&&void 0===r)return null;const n=this.orderParams(r),o=r.length>0?lp:[],i=t&&t.content,s=t&&t.description,a=t&&t.required;return e.createElement(e.Fragment,null,o.map((t=>e.createElement(Kc,{key:t,place:t,parameters:n[t]}))),i&&e.createElement(up,{content:i,description:s,bodyRequired:a}))}}function pp(t){var r=t,{bodyRequired:n}=r,o=ap(r,["bodyRequired"]);const i="boolean"==typeof n&&!!n,s="boolean"==typeof n&&!n;return e.createElement(bi,{key:"header"},"Request Body schema: ",e.createElement(ws,sp({},o)),i&&e.createElement(hp,null,"required"),s&&e.createElement(mp,null,"optional"))}function up(t){const{content:r,description:n,bodyRequired:o}=t,{isRequestType:i}=r;return e.createElement(ep,{content:r,renderDropdown:t=>e.createElement(pp,sp({bodyRequired:o},t))},(({schema:t})=>e.createElement(e.Fragment,null,void 0!==n&&e.createElement(Rs,{source:n}),"object"===(null==t?void 0:t.type)&&e.createElement(La,{constraints:(null==t?void 0:t.constraints)||[]}),e.createElement(zl,{skipReadOnly:i,skipWriteOnly:!i,key:"schema",schema:t}))))}const dp="\n  text-transform: lowercase;\n  margin-left: 0;\n  line-height: 1.5em;\n",hp=ee(va)`
  ${dp}
`,mp=ee("div")`
  ${dp}
  color: ${({theme:e})=>e.colors.text.secondary};
  font-size: ${e=>e.theme.schema.labelsTextSize};
`,fp=e.memo((function({title:t,type:r,empty:n,code:o,opened:i,className:s,onClick:a}){return e.createElement("button",{className:s,onClick:!n&&a||void 0,"aria-expanded":i,disabled:n},!n&&e.createElement(Pi,{size:"1.5em",color:r,direction:i?"down":"right",float:"left"}),e.createElement(xp,null,o," "),e.createElement(Rs,{compact:!0,inline:!0,source:t}))})),gp=ee(fp)`
  display: block;
  border: 0;
  width: 100%;
  text-align: left;
...
`,yp=ee.div`
  padding: 10px;
`,bp=ee(bi).attrs({as:"caption"})`
  text-align: left;
  margin-top: 1em;
  caption-side: top;
`,xp=ee.strong`
  vertical-align: top;
`;class vp extends e.PureComponent{render(){const{headers:t}=this.props;return void 0===t||0===t.length?null:e.createElement(Mi,null,e.createElement(bp,null," Response Headers "),e.createElement("tbody",null,d(t,((t,r)=>e.createElement(tl,{isLast:r,key:t.name,field:t,showExamples:!0})))))}}var wp=Object.defineProperty,kp=Object.getOwnPropertySymbols,Op=Object.prototype.hasOwnProperty,Ep=Object.prototype.propertyIsEnumerable,jp=(e,t,r)=>t in e?wp(e,t,{enumerable:!0,configurable:!0,writable:!0,value:r}):e[t]=r;class $p extends e.PureComponent{constructor(){super(...arguments),this.renderDropdown=t=>e.createElement(bi,{key:"header"},"Response Schema: ",e.createElement(ws,((e,t)=>{for(var r in t||(t={}))Op.call(t,r)&&jp(e,r,t[r]);if(kp)for(var r of kp(t))Ep.call(t,r)&&jp(e,r,t[r]);return e})({},t)))}render(){const{description:t,extensions:r,headers:n,content:o}=this.props.response;return e.createElement(e.Fragment,null,t&&e.createElement(Rs,{source:t}),e.createElement(Ra,{extensions:r}),e.createElement(vp,{headers:n}),e.createElement(ep,{content:o,renderDropdown:this.renderDropdown},(({schema:t})=>e.createElement(e.Fragment,null,"object"===(null==t?void 0:t.type)&&e.createElement(La,{constraints:(null==t?void 0:t.constraints)||[]}),e.createElement(zl,{skipWriteOnly:!0,key:"schema",schema:t})))))}}const Sp=(0,ha.observer)((({response:t})=>{const{extensions:r,headers:n,type:o,summary:i,description:s,code:a,expanded:l,content:c}=t,p=e.useMemo((()=>void 0===c?[]:c.mediaTypes.filter((e=>void 0!==e.schema))),[c]),u=e.useMemo((()=>!(r&&0!==Object.keys(r).length||0!==n.length||0!==p.length||s)),[r,n,p,s]);return e.createElement("div",null,e.createElement(gp,{onClick:()=>t.toggle(),type:o,empty:u,title:i||"",code:a,opened:l}),l&&!u&&e.createElement(yp,null,e.createElement($p,{response:t})))})),Cp=ee.h3`
  font-size: 1.3em;
  padding: 0.2em 0;
  margin: 3em 0 1.1em;
  color: ${({theme:e})=>e.colors.text.primary};
  font-weight: normal;
`;class Pp extends e.PureComponent{render(){const{responses:t,isCallback:r}=this.props;return t&&0!==t.length?e.createElement("div",null,e.createElement(Cp,null,_(r?"callbackResponses":"responses")),t.map((t=>e.createElement(Sp,{key:t.code,response:t})))):null}}function Ap(t){const{security:r,showSecuritySchemeType:n,expanded:o}=t,i=r.schemes.length>1;return 0===r.schemes.length?e.createElement(Jl,{$expanded:o},"None"):e.createElement(Jl,{$expanded:o},i&&"(",r.schemes.map((t=>e.createElement(Hl,{key:t.id},n&&`${ac[t.type]||t.type}: `,e.createElement("i",null,t.displayName),o&&t.scopes.length?[" (",t.scopes.map((t=>e.createElement(Vl,{key:t},t))),") "]:null))),i&&") ")}const Ip=({scopes:t})=>t.length?e.createElement("div",null,e.createElement("b",null,"Required scopes: "),t.map(((t,r)=>e.createElement(e.Fragment,{key:r},e.createElement("code",null,t)," ")))):null;function Tp(t){const r=Ei(),n=null==r?void 0:r.options.showSecuritySchemeType,[o,i]=(0,e.useState)(!1),{securities:s}=t;if(!(null==s?void 0:s.length)||(null==r?void 0:r.options.hideSecuritySection))return null;const a=null==r?void 0:r.spec.securitySchemes.schemes.filter((({id:e})=>s.find((t=>t.schemes.find((t=>t.id===e))))));return e.createElement(e.Fragment,null,e.createElement(Xl,{$expanded:o},e.createElement(Yl,{onClick:()=>i(!o)},e.createElement(Zl,null,"Authorizations:"),e.createElement(Pi,{size:"1.3em",direction:o?"down":"right"})),e.createElement(Gl,{$expanded:o},s.map(((t,r)=>e.createElement(Ap,{key:r,expanded:o,showSecuritySchemeType:n,security:t}))))),o&&!!(null==a?void 0:a.length)&&a.map(((t,r)=>e.createElement(ec,{key:r},e.createElement("h5",null,e.createElement(_p,null)," ",ac[t.type]||t.type,": ",t.id),e.createElement(Rs,{source:t.description||""}),e.createElement(sc,{key:t.id,scheme:t,RequiredScopes:e.createElement(Ip,{scopes:Rp(t.id,s)})})))))}const _p=()=>e.createElement("svg",{xmlns:"http://www.w3.org/2000/svg",viewBox:"0 0 24 24",width:"11",height:"11"},e.createElement("path",{fill:"currentColor",d:"M18 10V6A6 6 0 0 0 6 6v4H3v14h18V10h-3zM8 6c0-2.206 1.794-4 4-4s4 1.794 4 4v4H8V6zm11 16H5V12h14v10z"}));function Rp(e,t){const r=[];let n=t.length;for(;n--;){const o=t[n];let i=o.schemes.length;for(;i--;){const t=o.schemes[i];t.id===e&&Array.isArray(t.scopes)&&r.push(...t.scopes)}}return Array.from(new Set(r))}Object.defineProperty,Object.getOwnPropertyDescriptor;let Dp=class extends e.Component{render(){const{operation:t}=this.props,{description:r,externalDocs:n}=t,o=!(!r&&!n);return e.createElement(Qc,null,o&&e.createElement(zp,null,void 0!==r&&e.createElement(Rs,{source:r}),n&&e.createElement(Pa,{externalDocs:n})),e.createElement(Xc,{operation:this.props.operation,inverted:!0,compact:!0}),e.createElement(Ra,{extensions:t.extensions}),e.createElement(Tp,{securities:t.security}),e.createElement(cp,{parameters:t.parameters,body:t.requestBody}),e.createElement(Pp,{responses:t.responses,isCallback:t.isCallback}))}};Dp=((e,t)=>{for(var r,n=t,o=e.length-1;o>=0;o--)(r=e[o])&&(n=r(n)||n);return n})([ha.observer],Dp);const zp=ee.div`
  margin-bottom: ${({theme:e})=>3*e.spacing.unit}px;
`;Object.defineProperty,Object.getOwnPropertyDescriptor;let Lp=class extends e.Component{constructor(){super(...arguments),this.toggle=()=>{this.props.callbackOperation.toggle()}}render(){const{name:t,expanded:r,httpVerb:n,deprecated:o}=this.props.callbackOperation;return e.createElement(e.Fragment,null,e.createElement(Bc,{onClick:this.toggle,name:t,opened:r,httpVerb:n,deprecated:o}),r&&e.createElement(Dp,{operation:this.props.callbackOperation}))}};Lp=((e,t)=>{for(var r,n=t,o=e.length-1;o>=0;o--)(r=e[o])&&(n=r(n)||n);return n})([ha.observer],Lp);class Np extends e.PureComponent{render(){const{callbacks:t}=this.props;return t&&0!==t.length?e.createElement("div",null,e.createElement(Mp,null," Callbacks "),t.map((t=>t.operations.map(((r,n)=>e.createElement(Lp,{key:`${t.name}_${n}`,callbackOperation:r})))))):null}}const Mp=ee.h3`
  font-size: 1.3em;
  padding: 0.2em 0;
  margin: 3em 0 1.1em;
  color: ${({theme:e})=>e.colors.text.primary};
  font-weight: normal;
`;Object.defineProperty,Object.getOwnPropertyDescriptor;let qp=class extends e.Component{constructor(e){super(e),this.switchItem=({idx:e})=>{this.props.items&&void 0!==e&&this.setState({activeItemIdx:e})},this.state={activeItemIdx:0}}render(){const{items:t}=this.props;if(!t||!t.length)return null;return e.createElement(e.Fragment,null,e.createElement((({children:t})=>this.props.label?e.createElement(la,null,e.createElement(aa,null,this.props.label),t):t),null,this.props.renderDropdown({value:this.props.options[this.state.activeItemIdx].value,options:this.props.options,onChange:this.switchItem,ariaLabel:this.props.label||"Callback"})),this.props.children(t[this.state.activeItemIdx]))}};qp=((e,t)=>{for(var r,n=t,o=e.length-1;o>=0;o--)(r=e[o])&&(n=r(n)||n);return n})([ha.observer],qp);var Fp=Object.defineProperty,Bp=Object.defineProperties,Qp=(Object.getOwnPropertyDescriptor,Object.getOwnPropertyDescriptors),Up=Object.getOwnPropertySymbols,Wp=Object.prototype.hasOwnProperty,Vp=Object.prototype.propertyIsEnumerable,Hp=(e,t,r)=>t in e?Fp(e,t,{enumerable:!0,configurable:!0,writable:!0,value:r}):e[t]=r;let Jp=class extends e.Component{constructor(){super(...arguments),this.renderDropdown=t=>{return e.createElement(ws,(r=((e,t)=>{for(var r in t||(t={}))Wp.call(t,r)&&Hp(e,r,t[r]);if(Up)for(var r of Up(t))Vp.call(t,r)&&Hp(e,r,t[r]);return e})({Label:sa,Dropdown:ca},t),Bp(r,Qp({variant:"dark"}))));var r}}render(){const t=this.props.content;return void 0===t?null:e.createElement(ep,{content:t,renderDropdown:this.renderDropdown,withLabel:!0},(t=>e.createElement(ua,{key:"samples",mediaType:t,renderDropdown:this.renderDropdown})))}};Jp=((e,t)=>{for(var r,n=t,o=e.length-1;o>=0;o--)(r=e[o])&&(n=r(n)||n);return n})([ha.observer],Jp);class Yp extends e.Component{render(){const t=this.props.callback.codeSamples.find((e=>fo(e)));return t?e.createElement(Gp,null,e.createElement(Jp,{content:t.requestBodyContent})):null}}const Gp=ee.div`
  margin-top: 15px;
`;var Zp=Object.defineProperty,Xp=Object.defineProperties,Kp=(Object.getOwnPropertyDescriptor,Object.getOwnPropertyDescriptors),eu=Object.getOwnPropertySymbols,tu=Object.prototype.hasOwnProperty,ru=Object.prototype.propertyIsEnumerable,nu=(e,t,r)=>t in e?Zp(e,t,{enumerable:!0,configurable:!0,writable:!0,value:r}):e[t]=r;let ou=class extends e.Component{constructor(){super(...arguments),this.renderDropdown=t=>{return e.createElement(ws,(r=((e,t)=>{for(var r in t||(t={}))tu.call(t,r)&&nu(e,r,t[r]);if(eu)for(var r of eu(t))ru.call(t,r)&&nu(e,r,t[r]);return e})({Label:sa,Dropdown:ca},t),Xp(r,Kp({variant:"dark"}))));var r}}render(){const{callbacks:t}=this.props;if(!t||0===t.length)return null;const r=t.map((e=>e.operations.map((e=>e)))).reduce(((e,t)=>e.concat(t)),[]);if(!r.some((e=>e.codeSamples.length>0)))return null;const n=r.map(((e,t)=>({value:`${e.httpVerb.toUpperCase()}: ${e.name}`,idx:t})));return e.createElement("div",null,e.createElement(yi,null," Callback payload samples "),e.createElement(iu,null,e.createElement(qp,{items:r,renderDropdown:this.renderDropdown,label:"Callback",options:n},(t=>e.createElement(Yp,{key:"callbackPayloadSample",callback:t,renderDropdown:this.renderDropdown})))))}};ou.contextType=ce,ou=((e,t)=>{for(var r,n=t,o=e.length-1;o>=0;o--)(r=e[o])&&(n=r(n)||n);return n})([ha.observer],ou);const iu=ee.div`
  background: ${({theme:e})=>e.codeBlock.backgroundColor};
  padding: ${e=>4*e.theme.spacing.unit}px;
`;Object.defineProperty,Object.getOwnPropertyDescriptor;let su=class extends e.Component{render(){const{operation:t}=this.props,r=t.codeSamples,n=r.length>0,o=1===r.length&&this.context.hideSingleRequestSampleTab;return n&&e.createElement("div",null,e.createElement(yi,null," ",_("requestSamples")," "),e.createElement(Vi,{defaultIndex:0},e.createElement(Wi.TabList,{hidden:o},r.map((t=>e.createElement(Wi.Tab,{key:t.lang+"_"+(t.label||"")},void 0!==t.label?t.label:t.lang)))),r.map((t=>e.createElement(Wi.TabPanel,{key:t.lang+"_"+(t.label||"")},fo(t)?e.createElement("div",null,e.createElement(Jp,{content:t.requestBodyContent})):e.createElement(ta,{lang:t.lang,source:t.source}))))))||null}};su.contextType=ce,su=((e,t)=>{for(var r,n=t,o=e.length-1;o>=0;o--)(r=e[o])&&(n=r(n)||n);return n})([ha.observer],su),Object.defineProperty,Object.getOwnPropertyDescriptor;let au=class extends e.Component{render(){const{operation:t}=this.props,r=t.responses.filter((e=>e.content&&e.content.hasSample));return r.length>0&&e.createElement("div",null,e.createElement(yi,null," ",_("responseSamples")," "),e.createElement(Vi,{defaultIndex:0},e.createElement(Wi.TabList,null,r.map((t=>e.createElement(Wi.Tab,{className:"tab-"+t.type,key:t.code},t.code)))),r.map((t=>e.createElement(Wi.TabPanel,{key:t.code},e.createElement("div",null,e.createElement(Jp,{content:t.content})))))))||null}};au=((e,t)=>{for(var r,n=t,o=e.length-1;o>=0;o--)(r=e[o])&&(n=r(n)||n);return n})([ha.observer],au);var lu=Object.defineProperty,cu=Object.defineProperties,pu=Object.getOwnPropertyDescriptors,uu=Object.getOwnPropertySymbols,du=Object.prototype.hasOwnProperty,hu=Object.prototype.propertyIsEnumerable,mu=(e,t,r)=>t in e?lu(e,t,{enumerable:!0,configurable:!0,writable:!0,value:r}):e[t]=r;const fu=ee.div`
  margin-bottom: ${({theme:e})=>6*e.spacing.unit}px;
`,gu=(0,ha.observer)((({operation:t})=>{const{name:r,description:n,deprecated:o,externalDocs:i,isWebhook:s,httpVerb:a,badges:l}=t,c=!(!n&&!i),{showWebhookVerb:p}=e.useContext(ce),u=l.filter((({position:e})=>"before"===e)),d=l.filter((({position:e})=>"after"===e));return e.createElement(ce.Consumer,null,(l=>{return e.createElement(ui,(h=((e,t)=>{for(var r in t||(t={}))du.call(t,r)&&mu(e,r,t[r]);if(uu)for(var r of uu(t))hu.call(t,r)&&mu(e,r,t[r]);return e})({},{[ei]:t.operationHash}),m={id:t.operationHash},cu(h,pu(m))),e.createElement(ai,null,e.createElement(fi,null,e.createElement(Si,{to:t.id}),u.map((({name:t,color:r})=>e.createElement(Ai,{type:"primary",key:t,color:r},t))),r," ",o&&e.createElement(Ai,{type:"warning"}," Deprecated "),s&&e.createElement(Ai,{type:"primary"}," ","Webhook ",p&&a&&"| "+a.toUpperCase()),d.map((({name:t,color:r})=>e.createElement(Ai,{type:"primary",key:t,color:r},t)))),l.pathInMiddlePanel&&!s&&e.createElement(Xc,{operation:t,inverted:!0}),c&&e.createElement(fu,null,void 0!==n&&e.createElement(Rs,{source:n}),i&&e.createElement(Pa,{externalDocs:i})),e.createElement(Ra,{extensions:t.extensions}),e.createElement(Tp,{securities:t.security}),e.createElement(cp,{parameters:t.parameters,body:t.requestBody}),e.createElement(Pp,{responses:t.responses}),e.createElement(Np,{callbacks:t.callbacks})),e.createElement(pi,null,!l.pathInMiddlePanel&&!s&&e.createElement(Xc,{operation:t}),e.createElement(su,{operation:t}),e.createElement(au,{operation:t}),e.createElement(ou,{callbacks:t.callbacks})));var h,m}))}));var yu=Object.defineProperty,bu=Object.getOwnPropertyDescriptor,xu=Object.getOwnPropertySymbols,vu=Object.prototype.hasOwnProperty,wu=Object.prototype.propertyIsEnumerable,ku=(e,t,r)=>t in e?yu(e,t,{enumerable:!0,configurable:!0,writable:!0,value:r}):e[t]=r,Ou=(e,t,r,n)=>{for(var o,i=n>1?void 0:n?bu(t,r):t,s=e.length-1;s>=0;s--)(o=e[s])&&(i=(n?o(t,r,i):o(i))||i);return n&&i&&yu(t,r,i),i};let Eu=class extends e.Component{render(){const t=this.props.items;return 0===t.length?null:t.map((t=>e.createElement(ju,{key:t.id,item:t})))}};Eu=Ou([ha.observer],Eu);let ju=class extends e.Component{render(){const t=this.props.item;let r;const{type:n}=t;switch(n){case"group":r=null;break;case"tag":case"section":default:r=e.createElement(Su,((e,t)=>{for(var r in t||(t={}))vu.call(t,r)&&ku(e,r,t[r]);if(xu)for(var r of xu(t))wu.call(t,r)&&ku(e,r,t[r]);return e})({},this.props));break;case"operation":r=e.createElement(Cu,{item:t})}return e.createElement(e.Fragment,null,r&&e.createElement(li,{id:t.id,$underlined:"operation"===t.type},r),t.items&&e.createElement(Eu,{items:t.items}))}};ju=Ou([ha.observer],ju);const $u=t=>e.createElement(ai,{$compact:!0},t);let Su=class extends e.Component{render(){const{name:t,description:r,externalDocs:n,level:o}=this.props.item,i=2===o?gi:fi;return e.createElement(e.Fragment,null,e.createElement(ui,null,e.createElement(ai,{$compact:!1},e.createElement(i,null,e.createElement(Si,{to:this.props.item.id}),t))),e.createElement(Pc,{parentId:this.props.item.id,source:r||"",htmlWrap:$u}),n&&e.createElement(ui,null,e.createElement(ai,null,e.createElement(Pa,{externalDocs:n}))))}};Su=Ou([ha.observer],Su);let Cu=class extends e.Component{render(){return e.createElement(gu,{operation:this.props.item})}};Cu=Ou([ha.observer],Cu);var Pu=Object.defineProperty,Au=Object.defineProperties,Iu=(Object.getOwnPropertyDescriptor,Object.getOwnPropertyDescriptors),Tu=Object.getOwnPropertySymbols,_u=Object.prototype.hasOwnProperty,Ru=Object.prototype.propertyIsEnumerable,Du=(e,t,r)=>t in e?Pu(e,t,{enumerable:!0,configurable:!0,writable:!0,value:r}):e[t]=r;let zu=class extends e.Component{constructor(){super(...arguments),this.ref=e.createRef(),this.activate=e=>{this.props.onActivate(this.props.item),e.stopPropagation()}}componentDidMount(){this.scrollIntoViewIfActive()}componentDidUpdate(){this.scrollIntoViewIfActive()}scrollIntoViewIfActive(){this.props.item.active&&this.ref.current&&c(this.ref.current)}render(){const{item:t,withoutChildren:r}=this.props;return e.createElement(Rc,{tabIndex:0,onClick:this.activate,depth:t.depth,"data-item-id":t.id,role:"menuitem"},"operation"===t.type?e.createElement(Lu,(n=((e,t)=>{for(var r in t||(t={}))_u.call(t,r)&&Du(e,r,t[r]);if(Tu)for(var r of Tu(t))Ru.call(t,r)&&Du(e,r,t[r]);return e})({},this.props),Au(n,Iu({item:t})))):e.createElement(zc,{$depth:t.depth,$active:t.active,$type:t.type,ref:this.ref},"schema"===t.type&&e.createElement(Ic,{type:"schema"},"schema"),e.createElement(Lc,{width:"calc(100% - 38px)",title:t.sidebarLabel},t.sidebarLabel,this.props.children),t.depth>0&&t.items.length>0&&e.createElement(Pi,{float:"right",direction:t.expanded?"down":"right"})||null),!r&&t.items&&t.items.length>0&&e.createElement(Qu,{expanded:t.expanded,items:t.items,onActivate:this.props.onActivate}));var n}};zu=((e,t)=>{for(var r,n=t,o=e.length-1;o>=0;o--)(r=e[o])&&(n=r(n)||n);return n})([ha.observer],zu);const Lu=(0,ha.observer)((t=>{var r;const{item:n}=t,o=e.createRef(),{showWebhookVerb:i}=e.useContext(ce);return e.useEffect((()=>{t.item.active&&o.current&&c(o.current)}),[t.item.active,o]),e.createElement(zc,{$depth:n.depth,$active:n.active,$deprecated:n.deprecated,ref:o},n.badges&&(null==(r=n.badges)?void 0:r.map((({name:t,color:r})=>e.createElement(Ic,{type:"badge",color:r,key:t},t)))),n.isWebhook?e.createElement(Ic,{type:"hook"},i?n.httpVerb:_("webhook")):e.createElement(Ic,{type:n.httpVerb},yt(n.httpVerb)),e.createElement(Lc,{tabIndex:0,width:"calc(100% - 38px)"},n.sidebarLabel,t.children))}));var Nu=Object.defineProperty,Mu=(Object.getOwnPropertyDescriptor,Object.getOwnPropertySymbols),qu=Object.prototype.hasOwnProperty,Fu=Object.prototype.propertyIsEnumerable,Bu=(e,t,r)=>t in e?Nu(e,t,{enumerable:!0,configurable:!0,writable:!0,value:r}):e[t]=r;let Qu=class extends e.Component{render(){const{items:t,root:r,className:n}=this.props,o=null==this.props.expanded||this.props.expanded;return e.createElement(_c,((e,t)=>{for(var r in t||(t={}))qu.call(t,r)&&Bu(e,r,t[r]);if(Mu)for(var r of Mu(t))Fu.call(t,r)&&Bu(e,r,t[r]);return e})({className:n,style:this.props.style,$expanded:o},r?{role:"menu"}:{}),t.map(((t,r)=>e.createElement(zu,{key:r,item:t,onActivate:this.props.onActivate}))))}};function Uu(){const[t,r]=(0,e.useState)(!1);return(0,e.useEffect)((()=>{r(!0)}),[]),t?e.createElement("img",{alt:"redocly logo",onError:()=>r(!1),src:"https://cdn.redoc.ly/redoc/logo-mini.svg"}):null}Qu=((e,t)=>{for(var r,n=t,o=e.length-1;o>=0;o--)(r=e[o])&&(n=r(n)||n);return n})([ha.observer],Qu),Object.defineProperty,Object.getOwnPropertyDescriptor;let Wu=class extends e.Component{constructor(){super(...arguments),this.activate=e=>{if(e&&e.active&&this.context.menuToggle)return e.expanded?e.collapse():e.expand();this.props.menu.activateAndScroll(e,!0),setTimeout((()=>{this._updateScroll&&this._updateScroll()}))},this.saveScrollUpdate=e=>{this._updateScroll=e}}render(){const t=this.props.menu;return e.createElement(cs,{updateFn:this.saveScrollUpdate,className:this.props.className,options:{wheelPropagation:!1}},e.createElement(Qu,{items:t.items,onActivate:this.activate,root:!0}),e.createElement(Nc,null,e.createElement("a",{target:"_blank",rel:"noopener noreferrer",href:"https://redocly.com/redoc/"},e.createElement(Uu,null),"API docs by Redocly")))}};Wu.contextType=ce,Wu=((e,t)=>{for(var r,n=t,o=e.length-1;o>=0;o--)(r=e[o])&&(n=r(n)||n);return n})([ha.observer],Wu);const Vu=({open:t})=>{const r=t?8:-4;return e.createElement(Ju,null,e.createElement(Hu,{size:15,style:{transform:`translate(2px, ${r}px) rotate(180deg)`,transition:"transform 0.2s ease"}}),e.createElement(Hu,{size:15,style:{transform:`translate(2px, ${0-r}px)`,transition:"transform 0.2s ease"}}))},Hu=({size:t=10,className:r="",style:n})=>e.createElement("svg",{className:r,style:n||{},viewBox:"0 0 926.23699 573.74994",version:"1.1",x:"0px",y:"0px",width:t,height:t},e.createElement("g",{transform:"translate(904.92214,-879.1482)"},e.createElement("path",{d:"\n          m -673.67664,1221.6502 -231.2455,-231.24803 55.6165,\n          -55.627 c 30.5891,-30.59485 56.1806,-55.627 56.8701,-55.627 0.6894,\n          0 79.8637,78.60862 175.9427,174.68583 l 174.6892,174.6858 174.6892,\n          -174.6858 c 96.079,-96.07721 175.253196,-174.68583 175.942696,\n          -174.68583 0.6895,0 26.281,25.03215 56.8701,\n          55.627 l 55.6165,55.627 -231.245496,231.24803 c -127.185,127.1864\n          -231.5279,231.248 -231.873,231.248 -0.3451,0 -104.688,\n          -104.0616 -231.873,-231.248 z\n        ",fill:"currentColor"}))),Ju=ee.div`
  user-select: none;
  width: 20px;
  height: 20px;
  align-self: center;
  ...
  flex-direction: column;
  color: ${e=>e.theme.colors.primary.main};
`;let Yu;Object.defineProperty,Object.getOwnPropertyDescriptor,s&&(Yu=r(230));const Gu=Yu&&Yu(),Zu=ee.div`
...
`;let Ku=class extends e.Component{constructor(){super(...arguments),this.state={offsetTop:"0px"},this.toggleNavMenu=()=>{this.props.menu.toggleSidebar()}}componentDidMount(){Gu&&Gu.add(this.stickyElement),this.setState({offsetTop:this.getScrollYOffset(this.context)})}componentWillUnmount(){Gu&&Gu.remove(this.stickyElement)}getScrollYOffset(e){let t;return t=void 0!==this.props.scrollYOffset?W.normalizeScrollYOffset(this.props.scrollYOffset)():e.scrollYOffset(),t+"px"}render(){const t=this.props.menu.sideBarOpened,r=this.state.offsetTop;return e.createElement(e.Fragment,null,e.createElement(Zu,{$open:t,className:this.props.className,style:{top:r,height:`calc(100vh - ${r})`},ref:e=>{this.stickyElement=e}},this.props.children),!this.context.hideFab&&e.createElement(Xu,{onClick:this.toggleNavMenu},e.createElement(Vu,{open:t})))}};Ku.contextType=ce,Ku=((e,t)=>{for(var r,n=t,o=e.length-1;o>=0;o--)(r=e[o])&&(n=r(n)||n);return n})([ha.observer],Ku);const ed=ee.div`
...
`,nd=ee.div`
  padding: 5px 0;
`,od=ee.input.attrs((()=>({className:"search-input"})))`
...
`,ad=ee.i`
  ...
  font-style: normal;
  color: '#666';
`;var ld=Object.defineProperty,cd=Object.getOwnPropertyDescriptor;class pd extends e.PureComponent{constructor(e){super(e),this.activeItemRef=null,this.clear=()=>{this.setState({results:[],noResults:!1,term:"",activeItemIdx:-1}),this.props.marker.unmark()},this.handleKeyDown=e=>{if(27===e.keyCode&&this.clear(),40===e.keyCode&&(this.setState({activeItemIdx:Math.min(this.state.activeItemIdx+1,this.state.results.length-1)}),e.preventDefault()),38===e.keyCode&&(this.setState({activeItemIdx:Math.max(0,this.state.activeItemIdx-1)}),e.preventDefault()),13===e.keyCode){const e=this.state.results[this.state.activeItemIdx];if(e){const t=this.props.getItemById(e.meta);t&&this.props.onActivate(t)}}},this.search=e=>{const{minCharacterLengthToInitSearch:t}=this.context,r=e.target.value;r.length<t?this.clearResults(r):this.setState({term:r},(()=>this.searchCallback(this.state.term)))},this.state={results:[],noResults:!1,term:"",activeItemIdx:-1}}clearResults(e){this.setState({results:[],noResults:!1,term:e}),this.props.marker.unmark()}setResults(e,t){this.setState({results:e,noResults:0===e.length}),this.props.marker.mark(t)}searchCallback(e){this.props.search.search(e).then((t=>{this.setResults(t,e)}))}render(){const{activeItemIdx:t}=this.state,r=this.state.results.filter((e=>this.props.getItemById(e.meta))).map((e=>({item:this.props.getItemById(e.meta),score:e.score}))).sort(((e,t)=>t.score-e.score));return e.createElement(nd,{role:"search"},this.state.term&&e.createElement(ad,{onClick:this.clear},"×"),e.createElement(id,null),e.createElement(od,{value:this.state.term,onKeyDown:this.handleKeyDown,placeholder:"Search...","aria-label":"Search",type:"text",onChange:this.search}),r.length>0&&e.createElement(cs,{options:{wheelPropagation:!1}},e.createElement(sd,{"data-role":"search:results"},r.map(((r,n)=>e.createElement(zu,{item:Object.create(r.item,{active:{value:n===t}}),onActivate:this.props.onActivate,withoutChildren:!0,key:r.item.id,"data-role":"search:result"}))))),this.state.term&&this.state.noResults?e.createElement(sd,{"data-role":"search:results"},_("noResultsFound")):null)}}pd.contextType=ce,((e,t,r)=>{for(var n,o=cd(t,r),i=e.length-1;i>=0;i--)(n=e[i])&&(o=n(t,r,o)||o);o&&ld(t,r,o)})([xe.bind,(0,xe.debounce)(400)],pd.prototype,"searchCallback");class ud extends e.Component{componentDidMount(){this.props.store.onDidMount()}componentWillUnmount(){this.props.store.dispose()}render(){const{store:{spec:t,menu:r,options:n,search:o,marker:i}}=this.props,s=this.props.store;return e.createElement(X,{theme:n.theme},e.createElement(wi,{value:s},e.createElement(pe,{value:n},e.createElement(ed,{className:"redoc-wrap"},e.createElement(Ku,{menu:r,className:"menu-content"},e.createElement(kc,{info:t.info}),!n.disableSearch&&e.createElement(pd,{search:o,marker:i,getItemById:r.getItemById,onActivate:r.activateAndScroll})||null,e.createElement(Wu,{menu:r})),e.createElement(td,{className:"api-content"},e.createElement(bc,{store:s}),e.createElement(Eu,{items:r.items})),e.createElement(rd,null)))))}}ud.propTypes={store:le.instanceOf(uc).isRequired};var dd=Object.defineProperty,hd=Object.getOwnPropertySymbols,md=Object.prototype.hasOwnProperty,fd=Object.prototype.propertyIsEnumerable,gd=(e,t,r)=>t in e?dd(e,t,{enumerable:!0,configurable:!0,writable:!0,value:r}):e[t]=r,yd=(e,t)=>{for(var r in t||(t={}))md.call(t,r)&&gd(e,r,t[r]);if(hd)for(var r of hd(t))fd.call(t,r)&&gd(e,r,t[r]);return e};const bd=function(t){const{spec:n,specUrl:o,options:i={},onLoaded:s}=t,a=Q(i.hideLoading,!1),l=new W(i);if(void 0!==l.nonce)try{r.nc=l.nonce}catch(e){}return e.createElement(ne,null,e.createElement(Oi,{spec:n?yd({},n):void 0,specUrl:o,options:i,onLoaded:s},(({loading:t,store:r})=>t?a?null:e.createElement(ae,{color:l.theme.colors.primary.main}):e.createElement(ud,{store:r}))))}}(),n}()}));
//# sourceMappingURL=/sm/f69b9d06f8619dfc4b4e93de3d80b5a1345405cff161ebaab76c33ac7dd274d8.map